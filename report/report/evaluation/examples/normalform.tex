...
fun g3 (NONE, _) = NONE
  ...
  that they both ought to be generalised to \inlinesml{fun g (x, y) = x}. This
  ...
  that \inlinesml{(NONE, _) = NONE} would be generalised to \inlinesml{(x, _) =
  ...
  \inlinesml{x = NONE}. This has the side effect that the two resulting clauses
  can't be unified.

  \fixme{Better explanation, possibly some refs to the normal form chapter.}
