...
\section{Generalisiation}\fixme{Fatal: This doesn't hold! But it isn't too hard
  to fix. The problem is that generalising a pattern extends its domain: We can
  only do that when all following patterns are confused or shadowed.}
