...
\paragraph{Environment.} We assume two fixed constructor environments $\rho$ and $\psi$
for when determining coverage. $\rho$ is a mapping of constructors to their data
type and $\psi$ is a mapping of data types to a list of all constructors of that
data type.
