...
\def\descript{%
  ...
  give a DSL for describing rewriting rules among whole functions in SML is
  given, along with its semantics and examples of use.

  A small suite of rewriting rules is developed and tested on a body of code
  written by ourselves and sophomore students during an introductory programming
  course.
