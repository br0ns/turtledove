...
\fixme{This should go in the appendix with the other grammars, and then just a
  brief explanation should be brought here?}
...
\end{grammar}
  ...
  \caption{Grammar for scheme expressions. This is the normal sml expression
    grammar but without types, exceptions and \texttt{while}.  See \fref{fig:rule-grammar} for
...
\end{grammar}
  ...
  \caption{Grammar for scheme patterns. See \fref{fig:rule-grammar} for
