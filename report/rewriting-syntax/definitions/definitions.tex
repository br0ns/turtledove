...
\begin{tabular}{lMlMlMl}
  ...
  Patterns & patvar & \overline{x}, \overline{y}, \ldots & pat \\
  Transformers & transvar &  \mathbb{D}, \mathbb{E}, \ldots & trans \\
  Meta patterns & mpatvar & \mathcal{A}, \mathcal{B}, \ldots & mpat \\
  Scheme patterns & spatvar & \alpha, \beta, \ldots & spat \\
  Relations & relvar & \textsf{r}, \textsf{s}, \ldots & \mathcal{P}(mpat) \cup
  \mathcal{P}(mpat^2) \cup \ldots\\
