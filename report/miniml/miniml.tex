...
We denote alpha equivalence of expressions with the symbol $==a$.
...
\begin{eqnarray*}
  p^1_1 ==_{\pi_1} p^2_1 &\land& \sigma ++ \pi_1 |- e^1_1 ==a e^2_1\\
  &\vdots&\\
  p^1_n ==_{\pi_n} p^2_n &\land& \sigma ++ \pi_n |- e^1_n ==a e^2_n
\end{eqnarray*}
...
\section{Unification of function bodys}
...
\subsection{Elimination by unification}
