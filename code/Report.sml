...
local (* BEGIN toStringWithMaxWidth : int -> t -> string *)
    ...
    fun width r =
        case r of
          ...
          | Itemize {bullet, items} => size bullet + 2 +
                                       (foldl Int.max 0 o map width) items
...
fun enumerate rs = Enumerate {style = EnumStyle.Number,
                              items = rs}
