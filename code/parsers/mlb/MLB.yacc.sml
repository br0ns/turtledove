...
\\014\000\022\000\021\000\027\000\
\\011\000\000\000\000\000\000\000\
\\014\000\000\000\000\000\014\000\
\\016\000\008\000\063\000\061\000\
\\044\000\024\000\059\000\060\000\
\\038\000\025\000\058\000\054\000\
\\020\000\055\000\009\000\057\000\
\\032\000\026\000\007\000\018\000\
...
\\014\000\023\000\042\000\036\000\
\\019\000\030\000\047\000\000\000\
...
datatype svalue = VOID | ntVOID of unit ->  unit
 ...
 | ID of unit ->  (string) | strid of unit ->  (strid)
 | strbinds'' of unit ->  (strbinds)
 | strbinds' of unit ->  (strid*strbinds)
 | strbinds of unit ->  (strbinds) | sigid of unit ->  (sigid)
 | sigbinds'' of unit ->  (sigbinds)
 | sigbinds' of unit ->  (sigid*sigbinds)
 | sigbinds of unit ->  (sigbinds)
 | mlb of unit ->  (basdecs*comments) | id of unit ->  (basid)
 | fctid of unit ->  (fctid) | fctbinds'' of unit ->  (fctbinds)
 | fctbinds' of unit ->  (fctid*fctbinds)
 | fctbinds of unit ->  (fctbinds) | basids of unit ->  (basids)
 ...
 | basbinds of unit ->  (basbinds) | annStar of unit ->  (string list)
 | annPlus of unit ->  (string list) | ann of unit ->  (string)
end
...
|  ( 9, ( ( _, ( MlyValue.FILE FILE1, FILE1left, FILE1right)) :: 
...
|  ( 11, ( ( _, ( _, _, END1right)) :: ( _, ( MlyValue.basdecs 
...
MlyValue.basdecnode (fn _ => let val  (annPlus as annPlus1) = annPlus1
 ()
 val  (basdecs as basdecs1) = basdecs1 ()
 in (Ann (annPlus, basdecs))
end)
 in ( LrTable.NT 7, ( result, ANN1left, END1right), rest671)
end
|  ( 12, ( ( _, ( MlyValue.strbinds strbinds1, _, strbinds1right)) :: 
( _, ( _, STRUCTURE1left, _)) :: rest671)) => let val  result = 
MlyValue.basdecnode (fn _ => let val  (strbinds as strbinds1) = 
strbinds1 ()
 in (Structure strbinds)
end)
 in ( LrTable.NT 7, ( result, STRUCTURE1left, strbinds1right), rest671
)
end
|  ( 13, ( ( _, ( MlyValue.sigbinds sigbinds1, _, sigbinds1right)) :: 
( _, ( _, SIGNATURE1left, _)) :: rest671)) => let val  result = 
MlyValue.basdecnode (fn _ => let val  (sigbinds as sigbinds1) = 
sigbinds1 ()
 in (Signature sigbinds)
end)
 in ( LrTable.NT 7, ( result, SIGNATURE1left, sigbinds1right), rest671
)
end
|  ( 14, ( ( _, ( MlyValue.fctbinds fctbinds1, _, fctbinds1right)) :: 
( _, ( _, FUNCTOR1left, _)) :: rest671)) => let val  result = 
MlyValue.basdecnode (fn _ => let val  (fctbinds as fctbinds1) = 
fctbinds1 ()
 in (Functor fctbinds)
end)
...
|  ( 15, ( ( _, ( _, PRIM1left, PRIM1right)) :: rest671)) => let val  
result = MlyValue.basdecnode (fn _ => (Prim))
...
|  ( 46, ( ( _, ( MlyValue.STRING STRING1, STRING1left, STRING1right))
 :: rest671)) => let val  result = MlyValue.ann (fn _ => let val  (
